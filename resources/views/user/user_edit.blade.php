<form id="form_add" class="form" method="POST" action="{{ route('user.update',$user->id) }}">
    @method('PUT')
    @csrf
    <div class="py-10 px-7 px-lg-10">
        ...
        <div class="fv-row mb-5">
            ...
            <div class="image-input image-input-outline image-input-empty" data-kt-image-input="true" style="background-image: url({{ asset($user->profile_picture) }})">
        ...
        <div class="fv-row mb-5">
            ...
            <input type="text" class="form-control form-control-solid" placeholder="Enter Full name" name="name" value="{{$user->name}}"/>
        </div>
        <div class="row mb-5 gap-5 gap-md-0">
            <div class="col-md-6">
                <label class="fs-6 fw-semibold mb-2">Email</label>
                <input type="email" class="form-control form-control-solid" placeholder="Enter Email" name="email" value="{{$user->email}}"/>
            </div>
            <div class="col-md-6">
